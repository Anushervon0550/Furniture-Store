...
set "ANDROID_STUDIO_LOCAL_JBR=%LOCALAPPDATA%\Programs\Android Studio\jbr"
if exist "%ANDROID_STUDIO_LOCAL_JBR%\bin\java.exe" (
    set "JAVA_HOME=%ANDROID_STUDIO_LOCAL_JBR%"
    goto findJavaFromJavaHome
)
